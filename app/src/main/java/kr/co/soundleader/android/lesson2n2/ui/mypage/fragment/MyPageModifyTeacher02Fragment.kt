...
import kr.co.soundleader.android.lesson2n2.databinding.FragmentMyPageModifyTeacher02Binding
...
class MyPageModifyTeacher02Fragment : BaseFragment<FragmentMyPageModifyTeacher02Binding, MyPageModifyTeacherSharedViewModel>() {
    override val viewModel: MyPageModifyTeacherSharedViewModel by sharedViewModel()
    val dataRepo : DataRepository by inject()

    override fun getLayoutId(): Int {
        return R.layout.fragment_my_page_modify_teacher_02
    }
