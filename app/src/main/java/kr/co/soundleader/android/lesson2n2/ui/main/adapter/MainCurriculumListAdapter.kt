...
class MainCurriculumListAdapter(private val context: Context) :
     ...
     var datas = ArrayList<ArticleList>()
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            ...
            return when (viewType) {
                ...
                ITEM ->
                    ItemViewHolder(
                        LayoutInflater.from(context).inflate(R.layout.item_main_curriculum_list,parent,false)
                    )
                EMPTY -> // EMPTY
                    EmptyViewHolder(
   ...
   inner class HeaderViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    // 항목에 해당하는 뷰객체 가지는 뷰홀더
        inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            private val tv_matching: TextView = itemView.findViewById(R.id.tv_matching)
...
//            private val tv_songArtist: TextView = itemView.findViewById(R.id.tv_songArtist)
            ...
            fun bind(item: ArticleList) {
                ...
                layout_item.setOnClickListener {
                    ...
                    val intent = Intent(context, CurriculumDetailActivity::class.java)
