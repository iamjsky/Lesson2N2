...
class MainClassRoomStartTeacherListAdapter(private val context: Context) :
     ...
     var datas = ArrayList<ArticleList>()
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            ...
            return when (viewType) {
                ...
                ITEM ->
                    ItemViewHolder(
                        LayoutInflater.from(context).inflate(R.layout.item_main_class_room_start_teacher_list,parent,false)
                    )
                EMPTY -> // EMPTY
                    EmptyViewHolder(
