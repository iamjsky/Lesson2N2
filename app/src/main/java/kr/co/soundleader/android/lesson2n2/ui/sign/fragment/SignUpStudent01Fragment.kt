...
import kr.co.soundleader.android.lesson2n2.databinding.FragmentSignUpStudent01Binding
...
import kr.co.soundleader.android.lesson2n2.ui.sign.viewmodel.SignUpStudentSharedViewModel
import org.koin.android.ext.android.inject
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class SignUpStudent01Fragment : BaseFragment<FragmentSignUpStudent01Binding, SignUpStudentSharedViewModel>() {
    override val viewModel: SignUpStudentSharedViewModel by sharedViewModel()
    val dataRepo : DataRepository by inject()

    override fun getLayoutId(): Int {
        return R.layout.fragment_sign_up_student_01
    }
